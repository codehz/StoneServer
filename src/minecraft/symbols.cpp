...
// Generated on Sat Jul 21 2018 19:17:56 UTC
...
ServerInstance::ServerInstance(IMinecraftApp & p1, Whitelist & p2, OpsList const & p3, FilePathManager * p4, std::chrono::seconds p5, mcpe::string p6, mcpe::string p7, mcpe::string p8, LevelSettings p9, minecraft::api::Api & p10, int p11, bool p12, int p13, int p14, int p15, bool p16, std::vector<mcpe::string> const & p17, mcpe::string p18, mce::UUID const & p19, MinecraftEventing & p20, ResourcePackRepository & p21, ContentTierManager const & p22, ResourcePackManager & p23, std::function<std::unique_ptr<LevelStorage> ( Scheduler & )> p24, mcpe::string const & p25, LevelData * p26, TextFilteringProcessor * p27, ResourcePackManager * p28, std::function<void ( mcpe::string const & )> p29, std::function<void ( mcpe::string const & )> p30) {
    (this->*_ServerInstance_ServerInstance)(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30);
}
...
void minecraft_symbols_init(void* handle) {
    ...
    ((void*&) _ServerInstance_ServerInstance) = hybris_dlsym(handle, "__ptrI12LevelStorageSt14default_deleteIS13_EER9SchedulerEERKSsP9LevelDataP22TextFilteringProcessorPSZ_S11_IFvS1C_EES1J_");
    if (_ServerInstance_ServerInstance == nullptr) Log::error("MinecraftSymbols", "Unresolved symbol: %s", "__ptrI12LevelStorageSt14default_deleteIS13_EER9SchedulerEERKSsP9LevelDataP22TextFilteringProcessorPSZ_S11_IFvS1C_EES1J_");
